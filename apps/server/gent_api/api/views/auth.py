    ...
    return Response({
        ...
        'endpoints': {
            ...
            'repositories': {
                ...
                'detail': '/api/repos/{owner_ref}/{repo_name}/',
                'delete': '/api/repos/{owner_ref}/{repo_name}/delete/',
                'members': '/api/repos/{owner_ref}/{repo_name}/members/',
                'owner_ref_note': (
                    'owner_ref accepts a numeric user id or a lowercase username'
                ),
            },
            'branches': {
                'list': '/api/repos/{owner_ref}/{repo_name}/branches/',
                'create': '/api/repos/{owner_ref}/{repo_name}/branches/create/',
                'detail': '/api/repos/{owner_ref}/{repo_name}/branches/{branch_name}/',
            },
            'commits': {
                'list': '/api/repos/{owner_ref}/{repo_name}/commits/',
                'create': '/api/repos/{owner_ref}/{repo_name}/commits/create/',
                'detail': '/api/repos/{owner_ref}/{repo_name}/commits/{sha}/',
            },
            'tags': {
                'list': '/api/repos/{owner_ref}/{repo_name}/tags/',
                'create': '/api/repos/{owner_ref}/{repo_name}/tags/create/',
                'delete': '/api/repos/{owner_ref}/{repo_name}/tags/{tag_name}/',
            },
            'objects': {
                'tree_create': '/api/repos/{owner_ref}/{repo_name}/tree/create/',
                'tree': '/api/repos/{owner_ref}/{repo_name}/tree/{sha}/',
                'blob_create': '/api/repos/{owner_ref}/{repo_name}/blob/create/',
                'blob': '/api/repos/{owner_ref}/{repo_name}/blob/{sha}/',
            },
            'sync': {
                'push': '/api/repos/{owner_ref}/{repo_name}/push/',
                'pull': '/api/repos/{owner_ref}/{repo_name}/pull/?branch={name}&since={sha}',
                'clone': '/api/repos/{owner_ref}/{repo_name}/clone/',
            },
            'documentation': {
                'swagger': '/api/docs/',
                'redoc': '/api/redoc/',
